  ...
  <div class="deptManager-content">
    ...
    <el-form :inline="true" :model="search" class="demo-form-inline">
      ...
      <el-form-item class="right-button">
        <el-button type="success" @click="handleEdit({})" v-if="pageMenu.adddept">新增部门</el-button>
        <el-button type="danger" @click="batchDelete(tableChecked)" v-if="pageMenu.deldept">删除</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table
      ...
      <el-table-column prop="deviceCount" label="可管理设备数"></el-table-column>
      ...
      <el-table-column label="操作" width="250">
        <template slot-scope="scope">
          <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-if="pageMenu.editdept">编辑</el-button>
          <el-button type="warning" size="small" @click="handleEditDevice(scope.row)" v-if="pageMenu.pubdeptdev">分配设备
          </el-button>
          <el-button type="danger" size="small" @click="handleDelete(scope.row)" v-if="pageMenu.deldept">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="分配设备" :visible.sync="dialogVisibleDevice" width="80%" :before-close="handleClose" append-to-body>
      <el-form :label-width="formLabelWidth" :model="editForm">
        <el-form-item label="部门名称" prop="name">
          <el-input type="text" v-model="editForm.name" :disabled="true" placeholder="请输入部门名称"></el-input>
        </el-form-item>
        <el-form-item label="设备" prop="intro">
          <transferView v-if="dialogVisibleDevice" :List="staffList" ref="transferView" @changeTransfer="changeTransfer"></transferView>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
