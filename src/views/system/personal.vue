  ...
  <div class="password-content">
    ...
    <el-card class="box-card">
      <div class="content-p">
        ...
        <p>
          <el-button type="primary" size="small" @click="handlePsd()">修改密码</el-button>
        </p>
      </div>
    ...
    <!--  修改密码  -->
    <el-dialog title="修改密码" :visible.sync="dialogVisible" width="50%" :close-on-click-modal="false"
    ...
    <!--  修改基本信息  -->
    <el-dialog title="修改基本信息" :visible.sync="dialogVisibleOther" width="50%" :close-on-click-modal="false"
               :before-close="handleClose" append-to-body>
      <el-form :label-width="'120px'" :model="editForm" :rules="rules1" ref="editForm">
        <el-form-item label="昵称" prop="nickName">
          <el-input type="text" v-model="editForm.nickName" autocomplete="off"></el-input>
        </el-form-item>
