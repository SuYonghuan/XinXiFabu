  ...
  <div class="deptManager-content">
    ...
    >
      ...
      >
        <el-form-item label="设备组名称" prop="gName">
          <el-input
            type="text"
            v-model="deviceForm.gName"
            placeholder="请输入设备组名称"
          ></el-input>
        </el-form-item>
        <el-form-item label="分辨率" prop="name">
          <el-select
            v-model="deviceForm.screenInfoCode"
            :disabled="dialogType"
            @change="changeDevice"
            placeholder="屏幕属性"
          >
    ...
    >
      <el-button
        type="danger"
        style="float: right"
        @click="batchDeleteGroup(tableCheckedGroup)"
        >批量删除</el-button
      >
      <el-table
        :data="programList"
        @selection-change="handleDeletionGroup"
        style="width: 100%"
      >
        <el-table-column
          align="center"
