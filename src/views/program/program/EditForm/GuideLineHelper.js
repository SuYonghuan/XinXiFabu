...
export class GuideLineHelper {
  ...
  getLineGuideItems(skipShape) {
    ...
    return [...guideItems.filter((guideItem) => guideItem !== skipShape), stage,];
  }
  ...
  drawTips(guides, item) {
    ...
    guides.forEach(lg => {
      ...
      switch (lg.orientation) {
        case "V": {
          const pairs = [[box1.top, box.top], [box1.top, box.bottom], [box1.bottom, box.top], [box1.bottom, box.bottom]]
          const pair = pairs.sort((a, b) => Math.abs(a[1] - a[0]) - Math.abs(b[1] - b[0]))[0]
        ...
        case "H": {
          const pairs = [[box1.left, box.left], [box1.left, box.right], [box1.right, box.left], [box1.right, box.right]]
          const pair = pairs.sort((a, b) => Math.abs(a[1] - a[0]) - Math.abs(b[1] - b[0]))[0]
          const line = new Konva.Line({
