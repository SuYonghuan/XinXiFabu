    ...
    <el-tabs type="border-card" style="margin-top: 20px" @tab-click="tabClick">
      <el-tab-pane label="节目">
        ...
        <el-form :inline="true" :model="search" class="demo-form-inline">
          ...
          <el-form-item class="right-button">
            <el-button type="info" @click="handleEdit({})" v-if="pageMenu.addnewsgroup">新增插播</el-button>
      ...
      <el-tab-pane label="字幕">
        ...
        <el-form :inline="true" :model="search" class="demo-form-inline">
          ...
          <el-form-item class="right-button">
            <el-button type="info" @click="handleSubtitle({})" v-if="pageMenu.addsubtitle">新增字幕</el-button>
