<template>
  <div class="deptManager-content">
    ...
    <el-form :inline="true" :model="search" class="demo-form-inline">
      ...
      <el-form-item class="right-button">
        <el-button
          type="success"
          @click="handleEdit({})"
          v-if="pageMenu.addproggroup"
          >新增组</el-button
        >
        <el-button
          type="danger"
          @click="batchDelete(tableChecked)"
          v-if="pageMenu.delproggroup"
          >删除</el-button
        >
      </el-form-item>
    </el-form>
      ...
      <el-table-column label="操作" width="250px">
        <template slot-scope="scope">
          ...
          <el-dropdown
            ...
            v-if="pageMenu.publishproggroup"
          >
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              >
              <el-dropdown-item
                ><p @click="handleDeviceGroup(scope.row)">
                  发布设备组
                </p></el-dropdown-item
              >
            </el-dropdown-menu>
    ...
    >
      ...
      >
        ...
        <el-form-item label="分辨率" prop="screenInfoCode">
          <el-select
            v-model="editForm.screenInfoCode"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="handleClose('editForm')">取 消</el-button>
        <el-button type="primary" @click="submitDgForm('editForm')"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        groupName: [
          { required: true, message: "请输入节目组名称", trigger: "blur" },
        ],
        screenInfoCode: [
  ...
  methods: {
    ...
    handleEdit(item) {
      ...
      if (JSON.stringify(item) != "{}") {
        ...
        this.GetProgByGroupCode(
          this.editForm.screenInfoCode,
          this.editForm.code
        );
      } else {
        this.dialogTitle = "新增";
