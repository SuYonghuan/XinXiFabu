      ...
      <div class="echart-div">
        ...
        <div class="right-div">
          <div class="device-num">
            <p>设备总数</p>
            <p style="color: #E6A23C;font-size: 30px">
              {{ deviceData.totalDev }}
            </p>
          </div>
          <div class="device-run">
            <p>当前运行数量</p>
            <p style="color: #67C23A;font-size: 30px">
              {{ deviceData.runDev }}
            </p>
          </div>
        </div>
...
<script>
import { GetLineData, GetNowStatus } from "http/api/login";
...
.home-content {
  ...
  .device-div {
    width: 100%;
    height: calc(100vh - 80px - 32px - 80px - 20px);
    margin-top: 20px;
    padding: 20px;
    box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1);
    ...
    .echart-div {
      ...
      #lineChart {
        width: 80%;
        height: calc(100vh - 80px - 32px - 80px - 20px - 100px);
      }
