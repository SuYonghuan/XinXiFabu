...
//获取楼栋列表
export const GetDeviceOptions = (param) =>
	post(`${store.state.config.url}/api/Dev/GetDeviceOptions?token=${encodeURIComponent(mergeWordAndTimeStamp("/api/Dev/GetDeviceOptions"))}&time=${timeStamp()}`, param)
